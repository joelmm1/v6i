...
jQuery(document).ready(function() {
    ...
    */
//    $.backstretch("assets/img/backgrounds/toyota2.jpg");
    ...
    /*
        Form
    */
    $('.registration-form .legend-steps:first-child').fadeIn('slow');
    ...
    $('.registration-form .btn-next').on('click', function() {
    	var parent_legend = $(this).parents('.legend-steps');
    	var next_step = true;
        var targetStep = parent_legend.index();
        //alert(parent_legend.index());
    	...
    	parent_legend.find('input[type="text"], input[type="password"], textarea').each(function() {
    		if( $(this).val() == "" ) {
    	...
    	if( next_step ) {
    		parent_legend.fadeOut(400, function() {
	    		$(this).next().fadeIn();
	    	});
    	}
    ...
    $('.registration-form .btn-previous').on('click', function() {
        ...
        $('.step').eq(targetStep+1).prev().removeClass('active');

    	$(this).parents('.legend-steps').fadeOut(400, function() {
    		$(this).prev().fadeIn();
    	});
    });
    ...
    $('.rzslider .rz-pointer').on('mousemove', function(){
        $('.rzslider .rz-bar').css('background', '#993300');
        $('.rzslider .rz-bar.rz-selection').css('background', '#fff');
    });
