...
//	};
	...
	function calculateTotalPrice() {
		...
		var $totalCakePrice = getCakeSizePrice() + getFillingPrice() + getLovelyThingsPrice();
	...
	$('.cake-size, .filling, .lovely-things').change(function() {

		$('#total-cake-price').removeClass('hidden');
		$('#total-cake-price span').html(' Ksh' + calculateTotalPrice());
